...
Channel = x
# Bot key
key_bot_1 = "x"         #Author key [WAJIB DI ISI SEMUANNYA!!!]/berfungsi untuk akses bot tanpa login
key_bot_2 = "x"         #Author key [WAJIB DI ISI SEMUANNYA!!!]/berfungsi untuk akses bot tanpa login

# Text send msg
msg_bot_1 = """Pesan dari author 1 from var"""
msg_bot_2 = """Pesan dari author 2 from var"""

# Delay setings
# Bot Pertama
delay_bot_primary_jam = 0         # Delay bot utama/Jika tidak menggunakan jam 0 kan saja
delay_bot_primary_menit = 1       # Delay bot utama/Jika tidak menggunakan menit 0 kan saja
delay_bot_primary_detik = 0      # Delay bot utama/Jika tidak menggunakan detik 0 kan saja

# Bot lainnya
delay_bot_others_jam = 0    # Delay bot lainnya
delay_bot_others_menit = 2   # Delay bot lainnya
delay_bot_others_detik = 0   # Delay bot lainnya
