...
def send_messages():
    ...
    thread_3 = threading.Thread(target=send_message_with_delay, args=(url_1, payload_3, headers_3, delay_bot_others_seconds, webhook_url))
    thread_4 = threading.Thread(target=send_message_with_delay, args=(url_1, payload_4, headers_4, delay_bot_others_seconds, webhook_url))
    thread_5 = threading.Thread(target=send_message_with_delay, args=(url_1, payload_5, headers_5, delay_bot_others_seconds, webhook_url))
    thread_6 = threading.Thread(target=send_message_with_delay, args=(url_1, payload_6, headers_6, delay_bot_others_seconds, webhook_url))
